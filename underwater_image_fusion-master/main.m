...
% path = "E:/数据集/水池/大水池图像/8.jpg";
path = "../273.jpg";
% path = 'E:/数据集/水池/大水池图像/102.jpg';
% path= "E:\UCAS_spring_learning\水下Nerf三维重建\图像增强\Enhancing Underwater Images and Videos by Fusion\IMG_1907.JPG";
